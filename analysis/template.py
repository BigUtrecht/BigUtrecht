...
def dummyAnalysis():
    ...
    with Session() as s:
        ...
        map.map_dataframe(point_rush_avg_in_out, 'MorningIntensityIn', 1000, 500, 'Morning average intensity in',
                          '/tmp/map3.html', 'EveningIntensityIn', 'Evening average intensity in', 'MorningIntensityOut',
                          'Morning average intensity out', 'EveningIntensityOut', 'Evening average intensity out')

        # filter_rush = add_category.filter(add_category.Tijd == '08:00' | add_category.Tijd == '08:15')
        # filter_rush.show(50)
        #
        #
        #
